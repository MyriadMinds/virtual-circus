// TODO: Remove once ash and gpu_allocator can be updated.
use ash::vk;
...
impl VertexInputDynamicState {
  pub fn new(instance: &Instance, device: &Device) -> Self {
    let fp = vk::ExtVertexInputDynamicStateFn::load(|name| unsafe { mem::transmute(instance.get_device_proc_addr(device.handle(), name.as_ptr())) });
    Self { fp }
  }
